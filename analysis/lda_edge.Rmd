---
title: "LDA behavior in odd situations"
...
lda_fits <- lapply(dats, FUN = function(a_dat) return(LDATS::LDA_set(a_dat$document_term_table, topics = c(2:nspp), nseeds = 20, control = list(quiet = TRUE))))
