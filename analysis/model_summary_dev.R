...
loadd(best_config_all_dataset_fits_bbs_rtrg_102_18, cache = cache)
loadd(bbs_rtrg_102_18, cache = cache)

best_config_modified <- best_config_all_dataset_fits_bbs_rtrg_102_18 %>%
  dplyr::mutate(cpts = 2)

best_mod <- run_best_model(bbs_rtrg_102_18, best_config_modified, nit = 10000)
