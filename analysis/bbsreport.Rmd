...
ldats2 <- ldats_wrapper(data_list = rdat_6_11, seed = 4, ntopics = 2, ncpts = 0, formulas = c("intercept"))

plot(ldats2$lda[[1]])
plot(ldats2$ts[[1]])


ldats3 <- ldats_wrapper(data_list = rdat_6_11, seed = 4, ntopics = 3, ncpts = 0, formulas = c("intercept"))

plot(ldats3$lda[[1]])
plot(ldats3$ts[[1]])


ldats11 <- ldats_wrapper(data_list = rdat_6_11, seed = 4, ntopics = 11, ncpts = 0, formulas = c("intercept"))
