...
This seems to work. However, I would not have done it this way if not for the string of issues discussed above. It's unconventional! See below for sample results.
...
Here are the 5 performing models. The top 4 all have 2 topics and 1 changepoint.
