...
library(dplyr)
library(cvlt)
all_evals_portal_winter_plants_cv <- read_csv("all_evals_f_hasty_portal_winter_plants_cv.csv")
...
all_evals_portal_summer_plants_cv <- read_csv("all_evals_f_hasty_portal_summer_plants_cv.csv")
